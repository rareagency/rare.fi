  ...
  return (
    <section className="col-all grid justify-items-center pt-48 pb-48 p-8">
      ...
      <div className="grid grid-cols-4 gap-x-16 gap-y-8 p-4 md:grid-cols-2">
        ...
        <a href="https://www.simucu.be/" target="_blank" rel="noreferrer">
          <img src="/static/references/simucube.svg" alt="Simucube" />
        </a>
        <a href="https://instagrid.co" target="_blank" rel="noreferrer">
          <img
        ...
        <a href="https://linnunrata.fi" target="_blank" rel="noreferrer">
          <img src="/static/references/linnunrata.svg" alt="Linnunrata" />
        </a>
        <a href="https://cultsecurity.com/" target="_blank" rel="noreferrer">
          <img
        ...
        <a href="https://sharpershape.com/" target="_blank" rel="noreferrer">
          <img src="/static/references/sharper-shape.svg" alt="Sharper Shape" />
        </a>
        <a href="https://www.veracell.com/" target="_blank" rel="noreferrer">
