...
const Privacy = () => (
  <>
    ...
    <p>
      ...
      website, <a href="https://rare.fi">https://rare.fi</a>, and other sites we
      own and operate.
    </p>
    <p>
      This policy is effective as of 21 October 2021 and was last updated on 21
      October 2021.
    </p>
    ...
    <ul>
      <li>
        <b>Google Analytics:</b> Allows us to see where our traffic comes from,
        and how users tend to behave.
      </li>
      <li>
